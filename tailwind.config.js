...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        glow: "0 0 20px rgba(13,71,255,0.25)",
        "glow-lg": "0 0 48px rgba(13,71,255,0.30)",
        "glow-cyan": "0 0 20px rgba(0,194,255,0.25)",
        "glow-violet": "0 0 20px rgba(123,97,255,0.25)",
        "card": "0 1px 3px rgba(13,71,255,0.04), 0 4px 16px rgba(13,71,255,0.04)",
        "card-hover": "0 4px 24px rgba(13,71,255,0.10), 0 8px 40px rgba(13,71,255,0.06)",
        "glass": "0 8px 32px rgba(13,71,255,0.08)",
      },
      animation: {
