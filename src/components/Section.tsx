...
export default function Section({ children, className = "", id, textured = false }: SectionProps) {
  return (
    <section id={id} className={`relative py-16 md:py-24 ${textured ? "bg-charcoal" : ""} ${className}`}>
...
export function SectionHeading({
  ...
  return (
    <div className="mb-12 max-w-2xl">
      ...
      <h2 className="mt-3 font-display text-3xl font-bold text-surface md:text-4xl leading-tight">
        {title}
      </h2>
