...
const slides = [
  {
    ...
    description:
      "Enduring technology platforms unifying AI, SaaS, PaaS, DevOps, cybersecurity, automation, analytics, and multi-cloud infrastructure — built to adapt as technology evolves.",
  ...
  },
  {
    ...
    description:
      "Agentic workflows, tenant-aware LLM orchestrators, and automated analytics integrated directly into the platform core.",
    tag: "AI & Autonomous Workflows",
    cssVar: "var(--hero-bg-ai)",
    tabLabel: "AI & Analytics",
    tabDesc: "LLMs, RAG, and automation",
    color: "#7B61FF",
    icon: Brain,
  },
  {
    id: "devsecops",
    title: "Multi-cloud DevSecOps\n& Zero-Trust Security.",
    description:
      "Automated CI/CD, cybersecurity guardrails, and compliance tracking across AWS, Azure, GCP, and Kubernetes.",
  ...
  },
  {
    ...
    description:
      "Modern lakehouse architecture providing unified analytics, real-time data streaming, and strict access governance.",
    tag: "Data & Analytics Platform",
    cssVar: "var(--hero-bg-data)",
    tabLabel: "Data & Analytics",
    tabDesc: "Lakehouse & data pipelines",
    color: "#10B981",
    icon: Database,
  },
  {
    ...
    description:
      "Architected for post-quantum security and quantum-assisted optimization without needing future re-architectures.",
    tag: "Future-Proof Architecture",
    cssVar: "var(--hero-bg-quantum)",
    tabLabel: "Quantum-Ready",
    tabDesc: "Cryptographic agility",
    color: "#C084FC",
    icon: Atom,
  },
];
