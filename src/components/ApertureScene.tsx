...
export default function ApertureScene() {
  return (
    <div className="relative h-full w-full" aria-hidden="true">
      ...
      {/* Focus-pull glow */}
      <div className="absolute inset-[30%] rounded-full bg-[radial-gradient(circle_at_35%_30%,rgba(227,168,87,0.28),transparent_45%,rgba(63,124,118,0.22)_75%,transparent_100%)]" />
      ...
      {/* HUD readouts */}
      <div className="absolute left-[8%] top-[8%] font-slug text-[10px] tracking-widest text-surface/50">
        f/1.8
      </div>
      <div className="absolute right-[8%] top-[8%] font-slug text-[10px] tracking-widest text-surface/50">
        24 FPS
      </div>
      <div className="absolute bottom-[8%] left-[8%] font-slug text-[10px] tracking-widest text-tally">
        ● REC
      </div>
      <div className="absolute bottom-[8%] right-[8%] font-slug text-[10px] tracking-widest text-surface/50">
        ISO 800
      </div>

      <div className="absolute left-1/2 top-1/2 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-primary/40 bg-[radial-gradient(circle,rgba(227,168,87,0.25),rgba(63,124,118,0.14),transparent)] font-display text-3xl font-semibold text-surface shadow-[0_0_50px_rgba(227,168,87,0.25)]">
        X
      </div>
    </div>
  );
