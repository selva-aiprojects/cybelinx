...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden border-t-0 bg-charcoal/80">
      {/* Subtle glow border */}
      <div className="h-px w-full bg-gradient-to-r from-transparent via-primary/20 to-violet/20" />
      ...
      {/* Ambient orb */}
      <div
        className="absolute -top-32 right-0 h-96 w-96 rounded-full bg-primary/[0.03] blur-3xl pointer-events-none"
        aria-hidden
      />
              ...
              {socialLinks.map((s) => {
                ...
                return (
                  <a
                    ...
                    aria-label={s.label}
                    className="flex h-9 w-9 items-center justify-center rounded-xl border border-border/60 bg-background/50 text-slate/60 transition-all hover:border-primary/50 hover:bg-primary/5 hover:text-primary"
                  >
