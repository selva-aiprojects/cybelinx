...
export const metadata: Metadata = {
  title: "Industries",
  description: "Cybelinx serves 9 regulated industries \u2014 Banking, Healthcare, Pharma, HCM, Manufacturing, Retail, Logistics, Telecom, and Energy \u2014 all from one platform.",
};
