...
export const metadata: Metadata = {
  title: "Contact",
  description: `Request a demo or trial of Cybelinx products \u2014 CybeHRMS, CybeHospitality, and more. Talk to our product team about your enterprise requirements.`,
};
